...
class Thermostat extends Component {
  ...
  componentDidMount() {
    axios.get('/api/products/thermostat').then(res => {
      this.setState({
        items: res.data,

      })
    })
    axios.get('/api/products/thermostat/images').then(res => {
      this.setState({
        images: res.data
      })
    })
...
export default connect(mapStateToProps, actionOutputs)(Thermostat);
